...
var OverlayTrigger = React.createClass({displayName: 'OverlayTrigger',
  ...
  renderOverlay: function () {
    if (!this.state.isOverlayShown) {
      return React.createElement(ReactCSSTransitionGroup, { transitionName : 'in', transitionEnter : false, transitionLeave: true }, []);
    }
    ...
    return React.createElement(ReactCSSTransitionGroup, { transitionName : 'in', transitionEnter : true, transitionLeave: false }, children);
  },
  ...
  getPureOverlayDOMNode : function () {
      var overlayNode = this.getOverlayDOMNode();
      return overlayNode.firstChild;
  },

  calcOverlayPosition: function () {
    var childOffset = this.getPosition();

    var overlayNode = this.getPureOverlayDOMNode();
